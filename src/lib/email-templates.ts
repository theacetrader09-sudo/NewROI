...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>© ${new Date().getFullYear()} NeoQuant. All rights reserved.</p>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="message">
        Thank you for joining NeoQuant! We're excited to have you on board. To complete your registration and start earning, please verify your email address with the code below:
      </div>
    ...
    <div class="footer">
      ...
      <p style="margin-top: 15px;">© ${new Date().getFullYear()} NeoQuant. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
